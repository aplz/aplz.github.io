...
I received my PhD in Machine Learning (ML) and Natural Language Processing (NLP) from the [University of Bonn](https://mlai.cs.uni-bonn.de/) and [Fraunhofer IAIS](https://www.iais.fraunhofer.de/en.html) where I was member of the Text Mining group. Now I work on AI and data driven products, mostly.
...
I believe in open source, growth and giving back (to the tech community). These days, I’m more active in the community than on GitHub. Since 2024, I’ve been part of the PyCon DE & PyData Program Committee, as well as a member of the IT-Tage Curatorium.
...
* I maintain a (somewhat opinionated) [list of resources](resources/index.md), covering blogs, newsletters and social events in the AI and tech ecosphere.
